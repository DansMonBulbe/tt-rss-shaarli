function shaarli(id) {
	...
	new Ajax.Request("backend.php",	{
		...
		var share_url = ti.shaarli_url + "?post="+ encodeURIComponent(ti.link)+ "&title="+encodeURIComponent(ti.title)+ "&description="+encodeURIComponent(document.getSelection())+"&source=bookmarklet";
